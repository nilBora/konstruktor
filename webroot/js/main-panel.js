...
function drawChart(chartData, maximum) {
	...
	//$("#dream_chart").attr("href", "/Group/view/"+$('#DreamGrouplist').val());
}
...
function drawScene() { // Основная функция drawScene
	...
	ctx.drawImage(clockImage, 0, 0, 60, 60);
	...
	ctx.moveTo(-6, -1.2);
	ctx.lineTo(-6, 1.2);
	ctx.lineTo(clockRadius * 0.8, 1.5);
	ctx.lineTo(clockRadius * 0.8, -1.5);
...
clockImage.src = '/img/clock-back.png';
