<?php
// exit; Please wait about 15 min., Konstruktor.com is under maintenance...
/**
 * Index
 *
 ...
 */
/* 301 редирект для дубля главной страницы */
...
// HTTPS hardcode. Stable but not flexible
//Part 1: Uncomment this if HTTPS environment variable does not work
if (isset($_SERVER['HTTP_HOST'])
	&&in_array($_SERVER['HTTP_HOST'], array('konstruktor.com', 'stg.konstruktor.com'))) {
...
//Part 2: Uncomment this if HTTPS environment variable does not work
