...
<?
    if (isset($groupID)) {
?>
    Chat.initPanel($(".dropdown-chatPanel .dropdown-panel-wrapper").get(0), 0, 0, <?=$groupID?>);
<?
    } elseif (isset($roomID)) {
?>
    Chat.initPanel($(".dropdown-chatPanel .dropdown-panel-wrapper").get(0), 0, <?=$roomID?>);
<?
    } else {
?>
    Chat.initPanel($(".dropdown-chatPanel .dropdown-panel-wrapper").get(0), <?=(isset($chatUserID)) ? $chatUserID : '0'?>);
<?
    }
?>
