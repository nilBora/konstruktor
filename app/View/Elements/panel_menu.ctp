<?php
if($currUser['User']['is_confirmed'] && false):
?>
...
<div id="header">
						...
						<div class="myLinks">
								...
								<div class="group-select jq-selectbox clearfix" style="display: none;">
										...
										<div class="jq-selectbox__select groupTitle">
											<div class="jq-selectbox__select-text"><?php echo !empty($groupHeader)?$groupHeader['Group']['title']:array_values($userGroups)['0'];?></div>
		...
		<div class="openchat" id="open-user-list-panel">
...
<div id="menu">
		<div class="menu-wrapper">
					...
					<a class="planet <?=$this->params['action'] == 'planet' ? 'active' : ''?>" href="/Planet">
							<img src="/img/planet48.png" alt="planet">
					</a>
					<div class="clearfix"></div>
		</div>
</div>
...
<div class="logo-konstruktor">
	<a class="logo" href="/Group/view/7">
		<img src="/img/logo_footer_bwst.png" alt="konstruktor" width="60px" height="50px" >
	</a>
</div>
