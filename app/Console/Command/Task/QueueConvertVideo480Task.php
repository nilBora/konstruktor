 ...
 *
 */
class QueueConvertVideo480Task extends QueueTask {
	...
	public function run($data, $id = null) {
		...
		$x264->setKiloBitrate(1500);
		$ogg = new FFMpeg\Format\Video\Ogg();
		$ogg->setKiloBitrate(1500);
		$webm = new FFMpeg\Format\Video\WebM();
		$webm->setKiloBitrate(1500);
		$video
			->save($x264, $filepath.$filename.'_480p.mp4')
			->save($ogg, $filepath.$filename.'_480p.ogg')
			->save($webm, $filepath.$filename.'_480p.webm');
