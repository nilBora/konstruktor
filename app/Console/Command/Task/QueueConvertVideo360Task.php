 ...
 *
 */
class QueueConvertVideo360Task extends QueueTask {
	...
	public function run($data, $id = null) {
		...
		$x264->setKiloBitrate(800);
		$ogg = new FFMpeg\Format\Video\Ogg();
		$ogg->setKiloBitrate(800);
		$webm = new FFMpeg\Format\Video\WebM();
		$webm->setKiloBitrate(800);
		$video
			->save($x264, $filepath.$filename.'_360p.mp4')
			->save($ogg, $filepath.$filename.'_360p.ogg')
			->save($webm, $filepath.$filename.'_360p.webm');
