 ...
 *
 */
class QueueConvertVideo1080Task extends QueueTask {
	...
	public function run($data, $id = null) {
		...
		$video
			->save($x264, $filepath.$filename.'_1080p.mp4')
			->save($ogg, $filepath.$filename.'_1080p.ogg')
			->save($webm, $filepath.$filename.'_1080p.webm');
