 ...
 *
 */
class QueueConvertVideo720Task extends QueueTask {
	...
	public function run($data, $id = null) {
		...
		$x264->setKiloBitrate(3000);
		$ogg = new FFMpeg\Format\Video\Ogg();
		$ogg->setKiloBitrate(3000);
		$webm = new FFMpeg\Format\Video\WebM();
		$webm->setKiloBitrate(3000);
		$video
			->save($x264, $filepath.$filename.'_720p.mp4')
			->save($ogg, $filepath.$filename.'_720p.ogg')
			->save($webm, $filepath.$filename.'_720p.webm');
