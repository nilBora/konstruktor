...
!function ($) {
  ...
  Editable.DEFAULTS = {
    ...
    pastedImagesUploadURL: 'https://i.froala.com/upload_base64',
...
(function ($) {
  ...
  $.Editable.prototype.parseImageResponse = function (response) {
    try {
      var trig = this.triggerEvent('afterImageUpload', [response], false);
      if (!trig) {
        return false;
      }
	  
	  if( (typeof trig) == 'string' && trig.indexOf('link') != (-1)) {
		  response = trig;
	  }
