...
class ApiGroupCompComponent extends Component {
	...
	*/
	 ...
	 * @return void
	 */
	public function mark_group_as_dream() {
		if (!isset($this->_controller->request->data['group_id']) || !isset($this->_controller->request->data['is_dream'])) {
			throw new ApiIncorrectRequestException();
		}
		$this->_controller->ApiGroup->markGroupAsDream($this->_userId, $this->_controller->request->data);
		$this->_controller->setResponse();
	}
}
?>
