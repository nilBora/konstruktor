...
App::uses('ApiAccessDeniedException', 'Api.Vendor');
App::uses('ApiIncorrectRequestException', 'Api.Vendor');
App::uses('ApiUnauthorizedException', 'Api.Vendor');
/**
...
class ApiController extends PAjaxController {
	...
	public $uses =	array(
							...
							'Api.ApiUserEvent',
		                    'Api.ApiStatistic',
							'Api.ApiFavouriteUser',
							'Api.ApiFavouriteList',
							'Media.Media'
	);

	public $components = array('Download','Api.ApiUserComp','Api.ApiGroupComp','Api.ApiArticleComp','Api.ApiChatComp','Api.ApiDocumentComp',
							'Api.ApiProjectComp','Api.ApiSubscriptionComp','Api.ApiTaskComp','Api.ApiTimelineComp','Api.ApiUserEventComp',
							'Api.ApiFavouriteUserComp','Api.ApiFavouriteListComp');
	/**
	...
	*/
	protected function getComponent() {
		$componentsArr = array('ApiUserComp','ApiGroupComp','ApiArticleComp','ApiChatComp','ApiDocumentComp',
							...
							'ApiFavouriteUserComp','ApiFavouriteListComp');
	...
	*/
	public function index() {
		try {
			...
			if (!in_array($this->_action, array('login','register','fb_auth')) and !$this->checkToken()) {
