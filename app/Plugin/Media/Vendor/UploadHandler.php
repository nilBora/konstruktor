...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'usage_limit' => 'File Storage limit exceeded'
    );
    ...
    protected function trim_file_name($name,
        ...
        $name = trim($this->pcgbasename(stripslashes($name)), ".\x00..\x20");
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if(!$StorageLimit->checklimit($size))
            $error = 'usage_limit';
    ...
    protected function generate_response($content, $print_response = true) {
        if ($print_response) {
            // JSON_UNESCAPED_UNICODE - php 5.4+ only
            $json = defined('JSON_UNESCAPED_UNICODE') ? json_encode($content, JSON_UNESCAPED_UNICODE) : json_encode($content);
