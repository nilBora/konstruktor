 ...
 */
	protected function _writeMigration($name, $version, $migration) {
		...
		// brood hack because File model override utility File class
		$File = new FileManager($this->path . $version . '_' . strtolower($name) . '.php', true);
