 ...
 */
	Configure::write('Session', array(
		...
		'handler' => array(
	        'engine' => 'ComboSession',
	        'model' => 'AppSession',
			//possibility to enable caching sessions in future
	        //'cache' => 'session'
	    )
	));
 ...
 */
	...
	if(!empty(env('CACHE_SESSIONS'))){
		Configure::write('Session.handler.cache', 'sessions');
		Cache::config('sessions', CacheDsn::parse(env('CACHE_SESSIONS')));
	}
